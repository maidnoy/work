...
<table  align='center'  width="60%" class='tb'  >
    ...
    <form action='save_edit.php?id=<?php echo $row['id']; ?>'  method='post'>
        <td > 
        <input type='checkbox'  class='cb' > <label class='la'> 
        <input type="text" name="name" class='in' Maxlength= '20' value=' <?php echo $row['name'] ?>' >
        </label><input type="submit" name='edit' value="edit" size="5" class='ed'></td>
    ...
    <tr  class='tr' height="70px" >
        <td > <input type='checkbox'  class='cb' > <label class='la'> 
